...
Route::middleware('web')->group(function () {
    Route::post('/join', [JoinController::class, 'store'])->middleware('throttle:600,1');
    Route::post('/sessions/{session}/vote', [VoteController::class, 'store'])->middleware('throttle:600,1');
});
