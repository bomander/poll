    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                ...
                toggleText: t('auth.two_factor_challenge.toggle_to_code'),
            };
        }
        ...
        return {
            ...
            toggleText: t('auth.two_factor_challenge.toggle_to_recovery'),
        };
    }, [showRecoveryInput, t]);
                    ...
                    {({ errors, processing, clearErrors }) => (
                        <>
                            ...
                            <div className="text-center text-sm text-muted-foreground">
                                <span>{t('auth.two_factor_challenge.or')}</span>
                                <button
                                    type="button"
